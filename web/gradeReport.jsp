    ...
    <form action="<c:url value='/InstructorServlet' />" method="post">
        ...
        <table border = "1px solid black">
            ...
            <tr>
                ...
                <td><input type="text" name="gradePoints" style="text-align:right; border:none" readonly value="${rec.gradePoints}"></td>
                <td><input type="text" name="letterGrade" style="text-align:right; border:none" readonly value="${rec.letterGrade}"></td>
            </tr>
            </c:forEach>
